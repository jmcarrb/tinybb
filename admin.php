...
<html>
<head>
<title>TinyBB > Admin Login</title>
<style>
body {
background-color:#07477E;
background-image:url('admin/gbg.png');
background-repeat:repeat-x;
font-family:verdana;
font-size:12px;
}
...
<body>
<div id="head"><img src="admin/logo.png"></div>
<div id="login" align="center">
<div class="warning" align="center">Please login to access the administration panel</div>
<form action="index.php?page=login&return=admin" method="post">
...
<div id="footer">TinyBB Administration Panel <?php echo "$aversion"; ?></div>
</body>
</html>
<?php } ?>
<br /><br />